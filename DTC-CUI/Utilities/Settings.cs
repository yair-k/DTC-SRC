        ...
        public static void sendTowebhook1(string account, string accountType)
        {
            ...
            using (var sw = new StreamWriter(wr.GetRequestStream()))
            {
                var json = JsonConvert.SerializeObject(new
                {
                    username = "DTC AIO",
                    avatar_url =
                        "https://cdn.discordapp.com/attachments/708528132327735427/781294769375674378/DTC_Logo.png",
                    embeds = new[]
                    {
                        new
                        {
                            ...
                            footer = new
                            {
                                ...
                                text =
                                    $"[DTC AIO] | [HITS] {Program.Hits} - [FREES] {Program.Frees} - [FAILS] {Program.Fails} - [TOTAL] {Program.TotalChecks}"
                            }
                        }
                    }
                });
