...
namespace DTCCUI.Tools
{
    public class Parser
    {
        ...
        public static void Parser0()
        {
            ...
            {
                Console.Title =
                    "                                                                                       [>] DTCAIO | Dork Parser | vragon#0001 [<]";
                Task.Factory.StartNew(delegate { printt(); });
                return;
            }
            Export.InitializeBlacklist();
            Console.Title =
                "                                                                                       [>] DTCAIO | Dork Parser Menu | vragon#0001 [<]";
            Console.Clear();
            Console.WriteLine();
            Program.Ascii();
            Console.WriteLine();
        ...
        {            
            Console.Title = "                                                                                                 [>] DTCAIO | Bing Parser | vragon#0001 [<]";
        ...
        {
            Console.Title = "                                                                                                 [>] DTCAIO | AOL Parser | vragon#0001 [<]";
            for (;;)
            {
        ...
        {
            Console.Title = "                                                                                                 [>] DTCAIO | Ask Parser | vragon#0001 [<]";
            for (;;)
            {
                if (Program.Proxyindex > Program.Proxies.Count() - 2) Program.Proxyindex = 0;
                try
