    ...
    public class ProxyTools
    {
        ...
        public static void CheckProxy(string line)
        {
                        ...
                        if (flag2)
                        {
                            ...
                            if (!flag3)
                            {
                                ...
                                Console.WriteLine(string.Format("    {0} | Working proxy HTTP/s", line),
                                    Color.Lime);
                                Console.Title =
                                    string.Format("DTC AIO | Proxy Checker | Working: {0} Not Working: {1}",
            ...
            catch (Exception ex)
            {
                ...
                Variables.Dead++;
                Console.Title = string.Format("DTC AIO | Proxy Checker | Working: {0} Not Working: {1}",
                    Variables.Alive, Variables.Dead);
            }
        }
        ...
        {
            Console.Title =
                "                                                                                      [>] DTCAIO | Proxy Checker & Scraper | Quanotics#3931 [<]";
