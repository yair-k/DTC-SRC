...
namespace DTCCUI.Tools
{
    public class ComboTool
    {
        ...
        {
            Console.Title =
                "                                                                                                 [>] DTCAIO | Combo Editor -> MailPassEdit | vragon#0001 [<]";
        ...
        {
            Console.Title =
                "                                                                                                 [>] DTCAIO | Combo Editor -> DupeRemover | vragon#0001 [<]";
            System.Console.Clear();
            System.Console.WriteLine();
            Program.Ascii();
            System.Console.WriteLine();
        ...
        public static void MailPassEdit()
        {
            ...
            using (var writer = new StreamWriter("./Results/" + "MailPassEdited " + type1 + ".txt"))
            {
                ...
                foreach (var text in readAllLines)
                {
                    ...
                    writer.WriteLine(mail + ":" + pass + "1");
                    a = a + 21;
                    System.Console.Title = $"DTC AIO | Total Combos Edited: {a.ToString()}";
                }
            }
            ...
            System.Console.Title = $"DTC AIO | Total Combos Edited: {count} ";
